...
def adapthand_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    """
    """
    trajectory["action"] = trajectory["action"]
    trajectory["observation"]["EEF_state"] = trajectory["observation"]["state"][:, :-1]
...
OXE_STANDARDIZATION_TRANSFORMS = {
    "adapthand_dataset": adapthand_dataset_transform,
