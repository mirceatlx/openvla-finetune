...
class MultiThreadedAdhocDatasetBuilder(tfds.core.dataset_builders.AdhocBuilder):
    ...
    def _download_and_prepare(  # pytype: disable=signature-mismatch  # overriding-parameter-type-checks
        ...
        split_builder = ParallelSplitBuilder(
            ...
            example_writer = writer_lib.ExampleWriter(self.info.file_format),  # Cheng_6-7-2024 added this line
...
class ParallelSplitBuilder(split_builder_lib.SplitBuilder):
    def __init__(
        self, *args, generator_fcn, n_workers, max_episodes_in_memory, file_format=None, **kwargs # Cheng_6-7-2024 added "file_format=None" 
    ):
        super().__init__(*args, **kwargs)
        self._generator_fcn = generator_fcn
        self._n_workers = n_workers
        self._max_episodes_in_memory = max_episodes_in_memory
        self._file_format = file_format  # Cheng_6-7-2024 Error: AttributeError: 'ParallelSplitBuilder' object has no attribute '_file_format'
    ...
    def _build_from_generator(
        ...
        writer = writer_lib.Writer(
            ...
            # file_format=self._file_format,     # Cheng_6-7-2024 Error no attribute '_file_format'
            example_writer = writer_lib.ExampleWriter(self._file_format),  # Cheng_6-7-2024 added this line
        ...
        for i, episodes in enumerate(episode_lists):
            ...
            for result in itertools.chain(*results):
                ...
                # writer._num_examples += 1                # Cheng_6-7-2024 AttributeError: 'Writer' object has no attribute '_num_examples'
        pool.close()
